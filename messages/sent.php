...
// Fetch sent messages
$result = $conn->query("SELECT m.id, m.subject, m.created_at, u.username as receiver FROM messages m JOIN users u ON m.receiver_id = u.id WHERE m.sender_id = $user_id ORDER BY m.created_at DESC");
...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            ...
            <a href="inbox.php" class="btn btn-secondary">Inbox</a>
        </div>
    </div>
    <?= $message ?>
    <table class="table table-striped align-middle">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="view_sent_message.php?id=<?= urlencode($row['id']) ?>" class="btn btn-primary btn-sm">View</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
